export const ProductService = {
  ...
  getProductsSmall() {
    return Promise.resolve(this.getData().products.slice(0, 10));
  },

  getProductsMedium() {
    return Promise.resolve(this.getData().products.slice(0, 50));
  },

  getProductsLarge() {
    return Promise.resolve(this.getData().products.slice(0, 200));
  },
  ...
  async getProducts(params) {
    const queryParams = params
      ? Object.keys(params)
          ...
          .join("&")
      : "";
    const res = await fetch("https://dummyjson.com/products?" + queryParams).then((res) => res.json());
